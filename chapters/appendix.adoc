...
== Terminology
=== Ball Manipulation
Shooting is considered as manipulating the ball, the ball accidentally bouncing off the hull is not. Dribbling Device is banned in this division.
...
* Division C has the same timeouts.
* Dribbling Device is banned in Division C
